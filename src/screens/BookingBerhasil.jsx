...
export default function BookingBerhasil({
  ...
  return (
    <div className="bg-[#f8f9fa] h-full min-h-0 flex flex-col">
      {/* ── FROZEN HEADER ── */}
      <div className="flex-shrink-0 z-30 w-full bg-white shadow-[0px_1px_4px_0px_rgba(0,0,0,0.05)]">
        <StatusBar />
      ...
      {/* Scroll hanya jika konten tidak muat di layar kecil */}
      <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain">
        <div className="px-4 py-6 flex flex-col items-center pb-8">
          {/* Checkmark */}
          <div className="w-20 h-20 rounded-full bg-[#e8f6eb] flex items-center justify-center mb-4">
          ...
          {/* Ringkasan */}
          <div className="w-full mt-4 bg-white rounded-[12px] shadow-[0px_2px_8px_0px_rgba(0,0,0,0.05)] overflow-hidden">
          ...
          <button
            ...
            className="w-full mt-4 bg-[#2aa148] text-white text-[13px] font-bold rounded-[12px] h-12"
          >
